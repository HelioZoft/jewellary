        ...
        <div class="container">
            <div class="last-products">
                ...
                <section class="products">
                    <article>
                        <img src="{{ asset('user/images/1.jpg') }}" alt="">
                    ...
                    <article>
                        <img src="{{ asset('user/images/13.jpg') }}" alt="">
            ...
            <section class="quick-links">
                <article style="background-image: url('{{ asset('user/images/2.jpg') }}')">
                    <a href="#" class="table">
                        <div class="cell">
                            <div class="text">
                                <h4>Lorem ipsum</h4>
                ...
                <article class="red" style="background-image: url('{{ asset('user/images/3.jpg') }}')">
                    <a href="#" class="table">
                        <div class="cell">
                            <div class="text">
                                <h4>consequatur</h4>
                ...
                <article style="background-image: url('{{ asset('user/images/4.jpg') }}')">
                    <a href="#" class="table">
                        <div class="cell">
                            <div class="text">
